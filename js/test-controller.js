...
class TestController {
    constructor() {
        ...
        this.level = null;
        this.optionTranslations = {}; // 存储所有选项的中文翻译
    ...
    async generateOptions(wordData) {
        ...
        try {
            ...
            const translations = await translationHelper.batchTranslate(allOptions);
            
            // 存储选项和翻译
            this.currentOptions = allOptions;
            this.optionTranslations = translations; // 存储所有选项的中文翻译
    ...
    renderOptions() {
        ...
        this.currentOptions.forEach((option, index) => {
            ...
            const chinese = this.optionTranslations[mainText];
            
            // 显示格式：英文 (中文)，如果有中文翻译的话
            if (chinese) {
    ...
    async selectOption(selectedIndex) {
        ...
        const historyEntry = {
            ...
            optionTranslations: {...this.optionTranslations}, // 记录选项翻译
    ...
    async showPreviousWord(wordInfo) {
        ...
        this.optionTranslations = {...wordInfo.optionTranslations};
